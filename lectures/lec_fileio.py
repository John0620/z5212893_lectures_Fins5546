...
#SRCFILE is the absolute path to the qan_prc_2020.csv file inside the data folder
#under the PycharmProjects toolkit folder
...
for line in fobj:
    ...
    cnts_copy += line #cnts_copy = cnts_copy + line
