...
#To locate the first element of the data frame
df.loc['2020-01-02','Close']

#create a dataframe
u=pd.DataFrame({'a':[1,2,3],'b':[4,5,6],}, index=['c','d','e'])
print(u)

f = pd.DataFrame([[1, 4], [2, 5], [3, 6]], index=['c', 'd', 'e'], columns=['a', 'b'])
print(f)
...
# This will return 'False' if the series is not sorted.
...
a=ser_sort_inplace.sort_index(inplace=True)
print(a)
