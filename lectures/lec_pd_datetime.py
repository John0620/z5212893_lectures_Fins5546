...
start = dt.datetime(year=2020, month=12, day=31, hour=12)
...
print(prc.loc['2020-01-02':'2020-01-06'])

print(prc.loc['2019-03', 'Adj Close'].iloc[14])
print(type(a))
...
data = [[10, 18, 11], [20, 9, 44], [30, 3, 88], [100, 180, 1.1]]
da=pd.DataFrame(data)
print(da)
print(da.pct_change(periods=3))
