...
print(df)
df.loc['2020-01-03':'2020-01-10','Bday']
...
y = ser.loc['2020-01-03':'2020-01-10']
print(y)
print(type(y))
...
de=pd.DataFrame({'co11':range(10),'co12':range(10,20)}, index=list('acgfhibdje'))
print(de)
z=de.loc[['b','d','f','j'],['co11']]
print(z)
print(type(z))
...
x = df.iloc[10]
print(x)# --> raises IndexError because the DF contains 10 rows
...
dj=pd.DataFrame({'co11':range(0,20),'co12':range(20,40),'co13':range(40,60)})
print(dj)
print(len(dj))
rows=list(range(0, len(dj), 2))
print(rows)
result=dj.iloc[rows,[1]]
print(result)
